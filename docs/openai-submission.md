...
> Начальная подача текущего стабильного релиза. Добавлены русскоязычные навыки для аналитики,
...
> Каждый MCP-инструмент публикует бесплатную OAuth-схему `wildberries-agent-free`.
