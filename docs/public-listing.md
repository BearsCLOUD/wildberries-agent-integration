...
В официальном MCP Registry опубликована версия `0.1.19` со статусом `active` (проверено 5 сентября 2026).
Имя: `io.github.BearsCLOUD/wildberries-agent-integration`; подключение: `https://wb.seller.bears.ru/mcp`.
[Публичная запись Registry](https://registry.modelcontextprotocol.io/v0.1/servers/io.github.BearsCLOUD%2Fwildberries-agent-integration/versions/0.1.19).
